...
public class DataMhs extends javax.swing.JFrame {
  private Connection koneksi;
    private DynamicTableModel<Mahasiswa> tablemodel;
   private JDynamicTable jDynamicTable;
    
    public DataMhs() {
        koneksi = DatabaseUtil.getKoneksi();
        initComponents();
        tablemodel = new DynamicTableModel<>(Mahasiswa.class);
...
private MahasiswaService service = new MahasiswaService();
    ...
    private void jButtonTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTambahActionPerformed
        TambahMahasiswa tambah = new TambahMahasiswa(this, true);
        tambah.tambahMahasiswa();
        reload();
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        if(jDynamicTable.getSelectedRow() != -1){
            ...
            Mahasiswa mahasiswa = tablemodel.get(index);
            EditMahasiswa editmahasiswa = new EditMahasiswa(this, true);
            editmahasiswa.editMahasiswa(mahasiswa);
            reload();
        }else{
    ...
    private void jButtonHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHapusActionPerformed
       if(jDynamicTable.getSelectedRow() != -1){
           if(JOptionPane.showConfirmDialog(this, "Anda yakin akan menghapus data ?", "Hapus Data",
               ...
               int index  = jDynamicTable.convertRowIndexToModel(jDynamicTable.getSelectedRow());
               Mahasiswa mahasiswa = tablemodel.get(index);
               service.delete(mahasiswa.getNim());
               reload();
           }
            }else{
