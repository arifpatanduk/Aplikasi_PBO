...
public class EditMatkul extends javax.swing.JDialog {
    private Matkul matkul;
    public EditMatkul(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public void editMatkul(Matkul matkul){
        this.matkul = matkul;
        jTextFieldSks.setText(matkul.getSks());
        jTextFieldMatkul.setText(matkul.getMatkul());
        jTextFieldKode.setText(matkul.getKode());
