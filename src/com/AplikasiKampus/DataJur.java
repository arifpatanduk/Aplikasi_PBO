...
public class DataJur extends javax.swing.JFrame {

    private DynamicTableModel<Jurusan> tablemodel;
   private JDynamicTable jDynamicTable;
    
    public DataJur() {
        initComponents();
        tablemodel = new DynamicTableModel<>(Jurusan.class);
    ...
    private void reload()    {
        tablemodel.clear();
        List<Jurusan> list = service.selectAll();
        for(Jurusan jrs : list){
            tablemodel.add(jrs);
        }
    }
    ...
    private void jButtonTambah1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTambah1ActionPerformed
        TambahJurusan tambah = new TambahJurusan(this, true);
        tambah.tambahJurusan();
        reload();
    ...
    private void jButtonEdit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEdit1ActionPerformed
         if(jDynamicTable.getSelectedRow() != -1){
            ...
            Jurusan jrs = tablemodel.get(index);
            EditJurusan edit = new EditJurusan(this, true);
            edit.editJurusan(jrs);
            reload();
        }else{
